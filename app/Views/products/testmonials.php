...
<div class="section-body mt-4">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <hr>
            <form class="card-body form-horizontal"  id="AddTestmonial" method="post" enctype="multipart/form-data">
            <div id="accfbk" class="text-success"></div>
               
                 <div class="form-group row">
                    <label class="col-md-3 col-form-label">Person Name<span class="text-danger">*</span></label>
                    <div class="col-md-5">
                        <input type="text" id="person_name" class="form-control" name="person_name" required="required" placeholder="Enter person name">
                    <span id="person_name" class="text-danger"></span>
                    </div>
                </div>
                 <div class="form-group row">
                    ...
                    <span id="company_name" class="text-danger"></span>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-3 col-form-label">Message<span class="text-danger">*</span></label>
                    <div class="col-md-7">
                        
                        <textarea name='message' id='message' class='form-control' placeholder="Enter message" rows="10"></textarea>
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content" style="width:900px;margin-left: 100px;">
      <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel"><center>Edit Testmonial Details</center></h5>
...
<script type="text/javascript">
   ...
   function edit_item(id){
        ...
        $('#EditItem').modal('show'); 
        $('#EditItem_content').load('edit_testimonial/'+id);
