                                  ...
                                  ?>
                                   <tr>
                                      ...
                                      <td><?php echo $res->full_name;?></td>
                                       ...
                                       if($user_id == $res->id){
                                        ?>
                                        <a href="javascript:void(0)" onclick="edit_item(<?php echo $res->id;?>)"  class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
                                    <?php } ?>

                                            <a href="javascript:void(0)" onclick="delete_user(<?php echo $res->id;?>)"  class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Delete</a>
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content" style="width:900px;margin-left: 100px;">
      <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel"><center>Edit User Details</center></h5>
...
<script type="text/javascript">
   ...
   $('#AddUser').submit(function(e){
    ...
    function edit_item(id){
        ...
        $('#EditItem').modal('show'); 
        $('#EditItem_content').load('edit_user/'+id);
