                            ...
                            <div class="row gy-0 gx-5">
                                ...
                                <div class="col-xl-7 animated fadeInLeft">
                                    <div class="text-sm-center text-md-end">
                                        <h4 class="text-primary text-uppercase fw-bold mb-4">Welcome E&R Enterprise</h4>
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-xl-7 wow fadeInLeft" data-wow-delay="0.2s">
                        <div>
                            ...
                            <h1 class="display-5 mb-4">History and expertise of E&R Enterprise </h1>
                            ...
                            <p>We collaborate with leading manufacturers in China to ensure that our customers receive premium products at competitive prices. Let us simplify your shopping experience by handling every step of the process with professionalism and reliability.</p>
                            <div class="row g-4">
                                ...
                                <div class="col-sm-6">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h4>Call Us</h4>
                                            <p class="mb-0 fs-5" style="letter-spacing: 1px;">(+255) 000 000 000</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
